...
const NAV = [
  ...
  { href: '/admin/applications', label: 'Bayi/Tedarikçi Başvuruları', icon: 'fa-user-check' },
  ...
  { href: '/admin/referral-payouts', label: 'Paylaş & Kazan Ödemeleri', icon: 'fa-share-nodes' },
];
