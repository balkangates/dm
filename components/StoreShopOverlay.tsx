...
export default function StoreShopOverlay({
  ...
  onOrdered: () => void;
  // Ürün kartındaki "Sor" ikonuna basılınca tetiklenir — üst bileşen
  // (app/store/[storeId]/page.tsx) StoreDirectMessage panelini bu ürün
  // bağlamıyla açar. Verilmezse ProductCard'da "Sor" butonu görünmez.
  ...
  return (
    <>
      ...
      {/* ── Alt: yatay kaydırmalı ürün şeridi (video footer) — sağda
          ...
          right-14 boşluk bırakılıyor. scroll-snap ile kartlar parmakla
          kaydırınca hizalı "kilitlenir" (Reels/TikTok ürün rafı hissi);
          sol/sağ kenarlarda ince bir karartma ile şeridin devam ettiği
          ima edilir — fade zonu dar tutuluyor (10px) ve sonda gerçek bir
          nefes payı (w-4) bırakılıyor ki en sondaki kart sağ sınıra
          "yapışmış"/erimiş görünmesin, temiz bitsin. ── */}
      {products.length > 0 && (
        <div className="absolute bottom-2 lg:bottom-3 left-2 lg:left-3 right-14 lg:right-16 z-30">
          <div
            className="flex gap-1.5 lg:gap-2 overflow-x-auto no-scrollbar pb-0.5"
            style={{
          ...
          >
            ...
            {/* Şeridin sonuna gerçek bir nefes payı — son kart, dar fade
                zonunun (10px) tamamen dışında, temiz kenarla bitsin diye. */}
